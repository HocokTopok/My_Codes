...
***Note*** Гарантируется что setting заводится только от типов для которых определена функция конвертации ConvertFromString из файла converters.hpp (кстати можно написать концепт на проверку этого)
